...
$user_name = $_SESSION['user_name']; // stored during login

// Fetch all notes
$result = $conn->query("SELECT notes.*, users.name AS uploader FROM notes JOIN users ON notes.user_id = users.id ORDER BY uploaded_at DESC");
?>
